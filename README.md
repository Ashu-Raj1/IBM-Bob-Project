...
Author: Ashu Raj Project Type: Descriptive Analytics — HR Domain Tool Stack: Python · Streamlit · Pandas · Plotly
...
IBMProject/ ├── Hr_employee_Analytics.py # Main application (frontend + backend) ├── HR_Employee_Data.csv # Source dataset ├── requirements.txt # Python dependencies ├── PriyaSahu_ProjectReport.docx # Full project documentation └── README.md # This file
...
Project by Ashu Raj — HR Descriptive Analytics · 2024
